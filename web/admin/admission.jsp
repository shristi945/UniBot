...
<html>
    ...
    <body bgcolor="#f0f8ff">
        ...
        <%
         ...
         ResultSet rs=stm1.executeQuery("select * from chatterbot.admission_ques");
         ResultSet rs1=stm2.executeQuery("select * from chatterbot.admission_ans");         
        
        %>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <td><a href="add_add_que.jsp">Click Here To Add More Admission Ques</a></td>
                <td><a href="add_add_ans.jsp">Click Here To Add More Admission Ans</a></td>
        </tr>
        </table>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
        ...
        <a href="add_add_que.jsp">Click Here To Add More Admission Ques</a>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <th>A_ID</th>
        ...
        <%
            ...
            %>
                                <tr>
                                     ...
                                     <td><a href="aaedit.jsp" >EDIT</a></td>
                                     <td><a href="aaedit.jsp" >DELETE</a></td>
                                 </tr>
                                     <%
                                                         }                                     
%>

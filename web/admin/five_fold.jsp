...
<html>
    ...
    <body bgcolor="#f0f8ff">
        ...
        <%
         ...
         ResultSet rs=stm1.executeQuery("select * from chatterbot.five_fold_ques");
         ResultSet rs1=stm2.executeQuery("select * from chatterbot.five_fold_ans");         
        
        %>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <td><a href="add_add_que.jsp">Click Here To Add More Five Fold Ques</a></td>
                <td><a href="add_add_ans.jsp">Click Here To Add More Five Fold Ans</a></td>
        </tr>
        </table>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            ...
            %>
                                 <tr>
                                     ...
                                     <td>
                                         <a href="aqedit.jsp" >EDIT</a>
                                     </td>
                                     <td>
                                         <a href="aqdel.jsp" >DELETE</a>
                                     </td>
                                 
                              <% }%>
        </table>
        <a href="add_add_que.jsp">Click Here To Add More Five Fold Ques</a>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <th>A_ID</th>
        ...
        <%
            ...
            %>
                                <tr>
                                     ...
                                     <td><a href="faedit.jsp" >EDIT</a></td>
                                     <td><a href="faedit.jsp" >DELETE</a></td>
                                 </tr>
                                     <%
                                                         }                                     
%>
        </table>
        <a href="add_ff_que.jsp">Click Here To Add More five fold Ques</a>
    </body>
</html>

...
<html>
    ...
    <body bgcolor="#f0f8ff">
        ...
        <%
         ...
         ResultSet rs=stm1.executeQuery("select * from chatterbot.location_ques");
         ResultSet rs1=stm2.executeQuery("select * from chatterbot.location_ans");         
        
        %>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <td><a href="add_loc_que.jsp">Click Here To Add More Location Ques</a></td>
                <td><a href="add_loc_ans.jsp">Click Here To Add More Location Ans</a></td>
        </tr>
        </table>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
        ...
        <a href="add_loc_que.jsp">Click Here To Add More Location Ques</a>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <th>A_ID</th>

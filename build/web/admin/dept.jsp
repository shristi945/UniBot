...
<html>
    ...
    <body bgcolor="#f0f8ff">
        ...
        <%
         ...
         ResultSet rs=stm1.executeQuery("select * from chatterbot.dept_ques");
         ResultSet rs1=stm2.executeQuery("select * from chatterbot.dept_ans");         
        
        %>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <td><a href="add_dept_que.jsp">Click Here To Add More Dept Ques</a></td>
                <td><a href="add_dept_ans.jsp">Click Here To Add More Dept Ans</a></td>
        </tr>
        </table>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            ...
            %>
                                 <tr>
                                     ...
                                     <td>
                                         <a href="dqdel.jsp?pagename=dept.jsp &msg=<%=id%>" >DELETE</a>
                                     </td>
                                 
                              <% }%>
        </table>
        <a href="add_dept_que.jsp">Click Here To Add More Dept Ques</a>
        <br/></br></br></br>
        <table border='1px' cellpadding='10px' cellspacing='5px' style='background-color: #fffcf6' >
            <tr>
                <th>A_ID</th>
        ...
        <%
            ...
            %>
                                <tr>
                                     ...
                                     <td><a href="dadel.jsp?pagename=dept.jsp &msg=<%=a_id%>" >DELETE</a></td>
                                 </tr>
                                     <%
                                                         }                                     
%>
        </table>
        <a href="add_dept_ans.jsp">Click Here To Add More Dept Ans</a>
    </body>
</html>
